  ...
  <xsl:template match="/">
    <html lang="it">
      ...
      <body>
        <div class="header">
          <h1>Sitemap XML</h1>
          <p>Questo file Sitemap XML è generato automaticamente. È ciò che i motori di ricerca come Google usano per scansionare e ri-scansionare post/pagine/categorie del sito web.</p>
        </div>
        <div class="container">
          <p class="count">
            Questa sitemap contiene <strong><xsl:value-of select="count(sitemap:urlset/sitemap:url)"/></strong> URL.
          </p>
          <table>
            <thead>
              <tr>
